...
const TRIGGERS = [
  {
    words: ["imran", "Imran", "IMRAN", "ইমরান"],
    text: "👉আমার বস♻️ IMRAN BOSS এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো ‎‎‎‎‎‎‎‎‎[https://www.facebook.com/profile.php?id=61587039296724] 🔰 ♪√বস ফ্রি হলে আসবে,! 😜🐒",
    images: [
      "https://i.imgur.com/skOXv81.jpeg"
    ]
  },
  {
    words: ["@মি্ঁমি্ঁ বু্ঁড়ি্ঁ", "@মি্ঁমি্ঁ বু্ঁড়ি্ঁ", "@মি্ঁমি্ঁ বু্ঁড়ি্ঁ"],
    text: "-আমাকে মেনশন দিয়ে লাভ নাই- কারণ আমি একটা মেসেঞ্জার চ্যাট রোবট,🤖 আমাকে বানানো হয়েছে শুধুমাত্র আপনাদেরকে বিনোদনের জন্য, আমাকে বানিয়েছেন আমার বস ইমরান😽🫶 https://www.facebook.com/profile.php?id=61587039296724",
    images: [
