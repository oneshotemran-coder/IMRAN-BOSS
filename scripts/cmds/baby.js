...
module.exports = {
        ...
        langs: {
                bn: {
                        ...
                        error: "× সমস্যা হয়েছে: %1। প্রয়োজনে Contact fahim।"
                },
                en: {
                        noInput: "Bolo baby😘",
        ...
        onChat: async function ({ api, event, commandName }) {
                ...
                if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
                        ...
                        const randomReplies = [
                                ...
                                "𝗡𝗮𝘄 𝗔𝗺𝗮𝗿 𝗕𝗼𝘀𝘀 𝗞 𝗠𝗲𝗮𝘀𝘀𝗮𝗴𝗲 𝗗𝗮𝘄 https://www.facebook.com/fahim.ahmed.raj.077",
                                ...
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, ফারহান, ফাহিম ও তো করতে পারো😑?",
