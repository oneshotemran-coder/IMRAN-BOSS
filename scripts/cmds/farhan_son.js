...
module.exports.onStart = async function ({ api, event, args }) {
  ...
  if (args[0] === "off") {
    ...
    return api.sendMessage(
      "✅ ওকে IMRAN বস ওর চুদা বন্ধ করা হয়েছে!",
      event.threadID,
      event.messageID
    );
  }
...
module.exports.onChat = async function ({ api, event }) {
  ...
  const messages = [
    ...
    "\nআমার ইমরান বস তোর মা কে চুদে পল্টি মারবো! 😡",  
    "\nতোর মার গুদে ফুল ট্যাবলেট পুশ করবো! 🤡",  
    "\nতোর মার ভোদায় ইমরান বস গাধার মতো মাল ফালিয়ে দিবে!🔥",  
    "\nইমরান বস তোর মাকে গাধার মতো চুদে বলবো এটা কার মাল? 😂",  
    "\nএই খানকির পোলা বেশ্যার পোলা তোর মাকে চুদে আমার বস ইমরান সারা বেলা,🖕💯",  
    "\nবস ইমরান বস তোর মার গুদে ইনপুট দিয়ে আউটপুট নেবো! 💀",  
    "\nআম পাতা জোড়া জোড়া তোর মাকে চূদে আমার বস ইমরান উরাধুরা..!🖕💯",
    "\nতুই নাকি অনলাইনের কিং তোর মায়ের ভোদা মধ্যে বাজামু সাপের বিন বিনের তালে তালে চুদতে চুদতে নিয়া যামু খালে খালে নাই সাপ আমার বস ইমরান তোর অবৈধ বাপ💦👅..",
    ...
    "\nএই মুরগি খাংকির পোলা ইমরান বস তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস..!!",
    "\nখাংকির পোলা তুই ইমরান বস কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?",
