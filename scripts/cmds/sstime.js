...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    // 🖼️ Image list
    const images = [
      "https://i.imgur.com/KxRx9ze.jpeg"
    ];
...
📌- আজকে থেকে সবা'র 𝐒𝐒 টাইম বাংলাদেশ সময় ০৮:০০ থেকে ০৯:০০ ইন্ডিয়ান টাইম ৭:৩০ থেকে ৮:৩০ পর্যন্ত  ১ ঘন্টা কল থাকবে। অতএব সবাই ১০ মিনিট আগে কলে থাকতে হবে। [বাধ্যতামূলক]⚠️⚠️✅
